...
var global_fragment=null;

var global_writer = undefined;
...
(function() {
    ...
    function postProcessList(list) {
        var children = list.children,
            ...
            stylesFilter = CKEDITOR.plugins.padma.filters.stylesFilter;
    ...
    var plugin = (CKEDITOR.plugins.padma = {
        utils: {
        ...
        getRules: function(editor, filter) {
            var dtd = CKEDITOR.dtd,
                ...
                removeFontStyles = config.pasteFromWordUsingPadmaRemoveFontStyles !== false,
                removeStyles = config.pasteFromWordUsingPadmaRemoveStyles !== false;
            ...
            return {
                ...
                elements: {
                    ...
                    'cke:listbullet': function(element) {
                        if (element.getAncestor(/h\d/) && !config.pasteFromWordUsingPadmaNumberedHeadingToList)
                            delete element.name;
                    }
                },
    ...
    pasteProcessor.prototype = {
        toHtml: function(data) {
            ...
            writer.text = function( text ) {
                    // text = "hello";
                    text = convert_krutidev_to_unicode(text);
                    this._.output.push( text );
                    window.output = this._.output;
                }
    ...
    CKEDITOR.cleanPadma = function(data, editor) {
        ...
        dataFilter.addRules(CKEDITOR.plugins.padma.getRules(editor, dataFilter));

        // Allow extending data filter rules.
        editor.fire('beforeCleanPadma', {
            filter: dataFilter
        });
